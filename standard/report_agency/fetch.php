...
if($_POST["query"] != '')
{
	...
	bb.type_name AS name_type1 , cc.group_name AS name_group1 , dd.department_name AS name_depart1 , e.fileupload AS name_file1 ,
	 a.standard_number AS standard_number1 , a.standard_day AS standard_day1  , ff.agency_name AS name_agency1
	FROM main_std a 
	-- status
	...
	WHERE f.agency_id IN (".$search_text.")    GROUP BY  a.standard_idtb , x.statuss_name ,
      a.standard_detail  , bb.type_name , cc.group_name  , dd.department_name  , 
	  a.standard_day , a.standard_number , e.fileupload ,a.standard_day  , ff.agency_name
...
else
{
	...
	LEFT JOIN agency_tb ff ON f.agency_id = ff.agency_id
      ...
      a.standard_detail  , bb.type_name , cc.group_name  , dd.department_name  , a.standard_day , 
	  a.standard_number , e.fileupload ,a.standard_day , ff.agency_name";
}
