                        ...
                        <div class="card mt-12">
                            <div class="card-body">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <lable id="a33">จดหมายสอบถามจากสมอ.</lable>
                                    <input type="text" name="standard_pick" id="a3" class="form-control"> <br>
                                    <lable id="a44">วันที่ประชุม สมอ.</lable>
                                    <input type="text" name="standard_survey" id="a4" class="form-control"> <br>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="card-body">
                                    <div class="">
                                        <div class="form-group mb-2">
                                            ...
                                            <input type="text" name="standard_meet" class="form-control" placeholder="เช่น" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="">
                                    <div class="form-group mb-2 f-red">
                                        ...
                                        <input type="text" name="standard_number" class="form-control" placeholder="เช่น มอก. 538-2560" required>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="">
                                    <div class="form-group mb-2">
                                        ...
                                        <input type="text" name="standard_detail" class="form-control" placeholder="เช่น ถุงมือยางปราศจากเชื้อ" required>
                                    </div>
                                </div>
                            </div>
                        </div>
